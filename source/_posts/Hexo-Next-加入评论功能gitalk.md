...
md5.min.js
在themes\next\source\js\src\目录下创建md5.min.js, 并添加如下内容:

加这个代码的原因是: 部分文章的评论区会报Error: Validation Failed, 具体原因是由于 Github 限制labels长度不能超过50

引起的, 该问题解决方案来自Gitalk项目仓Issues 115, 通过MD5加密ID来缩短labels长度。
...
以上就是Next中添加gitalk评论的配置。

博客上传到GitHub上后, 打开页面进入某一篇文章
